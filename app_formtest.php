...
//    }
//    $tvalid = true;
//    if ($tvalid && empty($pformdata["gameName"]))
//    {
//        $tvalid = false;
//        $pformdata["err-gameName"] = "<p id=\"help-gameName\" class=\"help-block\">First Name Required</p>";
//    }
...
//    appFormNullAsEmpty($pform, "gameName");
//    appFormNullAsEmpty($pform, "lastName");
//    appFormNullAsEmpty($pform, "phoneNumber");
//    appFormNullAsEmpty($pform, "err-gameName");
//
//    $tcontent = <<<PAGE
...
//		        <div class="col-xs-9">
//		            <input type="email" class="form-register" id="inputEmail" name="inputEmail"
...
//		        <div class="col-xs-9">
//		            <input type="password" class="form-register" id="inputPassword"
...
//		        <div class="col-xs-9">
//		            <input type="password" class="form-register" id="confirmPassword" name="confirmPassword"
//                       placeholder="Confirm Password" value="{$pform["confirmPassword"]}">
//		        </div>
//		    </div>
//            <div class="form-group">
//                <label class="control-label col-xs-3" for="gameName">First Name:</label>
//                <div class="col-xs-9">
//                    <input type="text" class="form-register" id="gameName" name="gameName"
//                    placeholder="First Name" value="{$pform["gameName"]}">
//                    {$pform["err-gameName"]}
//                </div>
//            </div>
//            <div class="form-group">
...
//                <div class="col-xs-9">
//                    <input type="text" class="form-register" id="lastName"
...
//                <div class="col-xs-9">
//                    <input type="tel" class="form-register" id="phoneNumber"
...
//		        <div class="col-xs-9">
//		            <textarea rows="3" class="form-register" id="postalAddress" placeholder="Postal Address"></textarea>
//		        </div>
//		    </div>
//            <div class="form-group">
//                <label class="control-label col-xs-3" for="ZipCode">Post Code:</label>
//                <div class="col-xs-9">
//                    <input type="text" class="form-register" id="ZipCode" placeholder="Post Code">
//                </div>
//            </div>
//            <div class="form-group">
...
//				<div class="jumbotron">
//					<h1>Thank You {$pformdata["gameName"]} {$pformdata["lastName"]}</h1>
//					<p class="lead">Your account has been created.
//                    Thank you for keeping up to date with Footy around the World!</p>
